...
const FeedbackCard = ({position, text, image, name}: FeedbackCardProps) => {
    return (
...
const Feedbacks = () => {
    return (
        <>
            <div
                className='flex max-w-7xl flex-row gap-10 mx-auto md:flex-nowrap flex-wrap justify-center'>
            ...
            <div
                className='lg:flex-row pt-20 flex flex-col justify-between max-w-6xl mx-auto mt-8 gap-10'>
